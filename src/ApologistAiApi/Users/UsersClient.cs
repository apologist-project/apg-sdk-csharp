...
public partial class UsersClient : IUsersClient
{
    ...
    {
        var _queryString = new ApologistAiApi.Core.QueryStringBuilder.Builder(capacity: 7)
    ...
    {
        var _queryString = new ApologistAiApi.Core.QueryStringBuilder.Builder(capacity: 2)
            .Add("page", request.Page)
            .Add("per_page", request.PerPage)
            .MergeAdditional(options?.AdditionalQueryParameters)
            .Build();

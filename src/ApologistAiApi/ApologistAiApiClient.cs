...
public partial class ApologistAiApiClient : IApologistAiApiClient
{
    private readonly RawClient _client;

    public ApologistAiApiClient(string apiKey, ClientOptions? clientOptions = null)
    {
        ...
        if (clientOptions.Domain != null)
        {
            ...
            else if (clientOptions.BaseUrl == ApologistAiApiEnvironment.Default)
            {
                clientOptions.BaseUrl = $"https://{_domain}/api/v1";
            }
        }
        var platformHeaders = new Headers(
            ...
            {
                { "X-Fern-Language", "C#" },
                { "X-Fern-SDK-Name", "ApologistAiApi" },

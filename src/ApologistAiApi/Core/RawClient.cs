...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::ApologistAiApi.Core.ApiResponse> SendRequestAsync(
        global::ApologistAiApi.Core.BaseRequest request,
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::ApologistAiApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        if (!isRetryableContent || maxRetries == 0)
        {
            var response = await httpClient
                ...
                .ConfigureAwait(false);
            return new global::ApologistAiApi.Core.ApiResponse
            {
    ...
    private string BuildUrl(global::ApologistAiApi.Core.BaseRequest request)
    {

...
public class PauseConversationTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/conversations/id/pause")
                    .UsingPost()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Conversations.PauseConversationAsync(
            new PauseConversationRequest { Id = "id" }
        );

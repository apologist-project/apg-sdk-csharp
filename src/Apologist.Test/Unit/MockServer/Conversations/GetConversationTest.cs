...
public class GetConversationTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock.RequestBuilders.Request.Create().WithPath("/conversations/id").UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Conversations.GetConversationAsync(
            new GetConversationRequest { Id = "id" }
        );
